...
//**********TYPE ASSERTIONS//**********
//A way of changing the data type
//someValue is a variable.  It is of type unknown
// let someValue: unknown = "this is a string";
//strLength is a variable, type is number.  The value is someValue is being converted to a string.
// let strLength: number = (someValue as string).length;
// console.log(strLength)

//can also be written like this (angle-bracket syntax):
let someValue: unknown = "this is a string";
